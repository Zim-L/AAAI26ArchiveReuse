...
public class FastMath {
     ...
     * @exception JMetalException if n cannot fit into an int
     * @since 3.4
     */
    public static int toIntExact(final long n) throws JMetalException {
        if (n < Integer.MIN_VALUE || n > Integer.MAX_VALUE) {
            throw new JMetalException("Integer Overflow");
        }
        return (int) n;
    }
     ...
     * @exception JMetalException if an overflow occurs
     * @since 3.4
     */
    public static int incrementExact(final int n) throws JMetalException {

        if (n == Integer.MAX_VALUE) {
            throw new JMetalException("Increment Overflow");
        }
     ...
     * @since 3.4
     */
    public static long incrementExact(final long n) throws JMetalException {
     ...
     * @since 3.4
     */
    public static int decrementExact(final int n) throws JMetalException {

        if (n == Integer.MIN_VALUE) {
            throw new JMetalException("Decrement Overflow");
        }
     ...
     * @since 3.4
     */
    public static long decrementExact(final long n) throws JMetalException {
     ...
     * @since 3.4
     */
    public static int addExact(final int a, final int b) throws JMetalException {
        ...
        // check for overflow
        if ((a ^ b) >= 0 && (sum ^ b) < 0) {
            throw new JMetalException("Increment overflow from "+a+" and "+b);
        }
     ...
     * @since 3.4
     */
    public static long addExact(final long a, final long b) throws JMetalException {
    ...
    public static int subtractExact(final int a, final int b) {
        ...
        // check for overflow
        if ((a ^ b) < 0 && (sub ^ b) >= 0) {
            throw new JMetalException("Decrement overflow from "+a+" and "+b);
        }
    ...
    public static long subtractExact(final long a, final long b) {
        ...
        // check for overflow
        if ((a ^ b) < 0 && (sub ^ b) >= 0) {
            throw new JMetalException("Subtraction overflow from "+ a +" and "+b);
        }
    ...
    public static int multiplyExact(final int a, final int b) {
        if (((b  >  0)  && (a > Integer.MAX_VALUE / b || a < Integer.MIN_VALUE / b)) ||
            ...
            throw new JMetalException("Multiplication overflow from "+ a +" and "+b);
        }
        return a * b;
    }
     ...
     * @exception JMetalException if b == 0
     * @see #floorMod(int, int)
     * @since 3.4
     */
    public static int floorDiv(final int a, final int b) throws JMetalException {

        if (b == 0) {
            throw new JMetalException("Zero Denominator");
        }
     ...
     * @since 3.4
     */
    public static long floorDiv(final long a, final long b) throws JMetalException {
     ...
     * @since 3.4
     */
    public static int floorMod(final int a, final int b) throws JMetalException {
    ...
    class FastMathCalc {
        ...
        private static void checkLen(int expectedLen, int actual)
            ...
            if (expectedLen != actual) {
                throw new JMetalException("Got "+actual +" while expecting "+ expectedLen);
            }
        }
        ...
        private static double roundUnscaled(double unscaled,
            ...
            case BigDecimal.ROUND_UNNECESSARY :
                if (unscaled != FastMath.floor(unscaled)) {
                    throw new JMetalException("Unscaled mismatch");
                }
                break;
            case BigDecimal.ROUND_UP :
                ...
                break;
            default :
                throw new JMetalException("Invalid rounding method " + roundingMethod);
            }
            return unscaled;
        }
