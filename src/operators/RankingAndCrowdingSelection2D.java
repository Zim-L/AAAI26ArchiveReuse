...
import core.CrowdingDistanceDensityEstimator;
...
public class RankingAndCrowdingSelection2D<S extends Solution<?>> implements SelectionOperator<List<S>, List<S>> {
	private final int solutionsToSelect;
	private Comparator<S> dominanceComparator;

	/** Constructor */
	public RankingAndCrowdingSelection2D(int solutionsToSelect, Comparator<S> dominanceComparator) {
		this.dominanceComparator = dominanceComparator;
		this.solutionsToSelect = solutionsToSelect;
	}

	/** Constructor */
	public RankingAndCrowdingSelection2D(int solutionsToSelect) {
	...
	public List<S> execute(List<S> solutionList) throws JMetalException {
		...
		Ranking<S> ranking = new JansenNonDominatedSortRanking<S>(dominanceComparator);
